...
const JobBoardComponent = ({ 
    ...
    return (
        <div className={`flex flex-col bg-white shadow-md my-16 mx-10 p-6 rounded ${featured && 'border-l-4 border-teal-500 border-solid'} lg:flex-row lg:my-4`}>
            <div>
            ...
            <div className="flex flex-col justify-between ml-4">
                <h3 className="font-bold text-teal-500">
                    {company}
                    {isNew && (
                        <span className="text-teal-100 bg-teal-500 m-2 py-1 px-2 rounded-full uppercase text-sm">New!</span>
                    )}
                    {featured && (
